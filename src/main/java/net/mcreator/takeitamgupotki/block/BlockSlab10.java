...
public class BlockSlab10 extends ElementsTakeitamgupotki.ModElement {
	@GameRegistry.ObjectHolder("takeitamgupotki:slab10")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("takeitamgupotki:slab10_double")
	public static final Block block_slab_double = null;
	public BlockSlab10(ElementsTakeitamgupotki instance) {
		super(instance, 13);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("slab10"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("slab10_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("takeitamgupotki:slab10", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("slab10");
