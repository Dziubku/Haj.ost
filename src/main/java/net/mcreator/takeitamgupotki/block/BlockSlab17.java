...
public class BlockSlab17 extends ElementsTakeitamgupotki.ModElement {
	@GameRegistry.ObjectHolder("takeitamgupotki:slab17")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("takeitamgupotki:slab17_double")
	public static final Block block_slab_double = null;
	public BlockSlab17(ElementsTakeitamgupotki instance) {
		super(instance, 20);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("slab17"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("slab17_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("takeitamgupotki:slab17", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("slab17");
