...
public class BlockSlab5 extends ElementsTakeitamgupotki.ModElement {
	@GameRegistry.ObjectHolder("takeitamgupotki:slab5")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("takeitamgupotki:slab5_double")
	public static final Block block_slab_double = null;
	public BlockSlab5(ElementsTakeitamgupotki instance) {
		super(instance, 8);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("slab5"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("slab5_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("takeitamgupotki:slab5", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("slab5");
