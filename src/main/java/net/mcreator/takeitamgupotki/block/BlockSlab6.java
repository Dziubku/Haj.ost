...
public class BlockSlab6 extends ElementsTakeitamgupotki.ModElement {
	@GameRegistry.ObjectHolder("takeitamgupotki:slab6")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("takeitamgupotki:slab6_double")
	public static final Block block_slab_double = null;
	public BlockSlab6(ElementsTakeitamgupotki instance) {
		super(instance, 9);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("slab6"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("slab6_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("takeitamgupotki:slab6", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("slab6");
