...
public class BlockSlab7 extends ElementsTakeitamgupotki.ModElement {
	@GameRegistry.ObjectHolder("takeitamgupotki:slab7")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("takeitamgupotki:slab7_double")
	public static final Block block_slab_double = null;
	public BlockSlab7(ElementsTakeitamgupotki instance) {
		super(instance, 10);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("slab7"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("slab7_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("takeitamgupotki:slab7", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("slab7");
