...
public class BlockStairs4 extends ElementsTakeitamgupotki.ModElement {
	@GameRegistry.ObjectHolder("takeitamgupotki:stairs4")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("takeitamgupotki:stairs4_double")
	public static final Block block_slab_double = null;
	public BlockStairs4(ElementsTakeitamgupotki instance) {
		super(instance, 24);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("stairs4"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("stairs4_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("takeitamgupotki:stairs4", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("stairs4");
